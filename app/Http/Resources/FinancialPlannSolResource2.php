...
class FinancialPlannSolResource2 extends JsonResource
{
    /**
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'for_Table' => $this->q_finPlSo_forTable,
            ...
            'todos' => TodosResource::collection(Todos::where('q_tdo_fromTable',$this->q_finPlSo_forTable)->get()),
        ];
    }
}
